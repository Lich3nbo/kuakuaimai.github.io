$(function(){
	...
	function leaderNav(data){
		...
		$('#li7').on("click",function(){
			...
			$('#li8').get(0).href ="getgsshop.html";
			$('#li10').get(0).href ="sitenav.html";
			$('#li11').get(0).href ="brand.html";
		})
		$('#li0').get(0).href ="sore.html";
		$('#li1').get(0).href ="favorable.html";
		$('#li2').get(0).href ="getinlanddiscount.html";
		$("#li3").get(0).href ="bargin.html";
		$("#li4").get(0).href ="favorable.html";
		$("#li5").get(0).href ="coupon.html";
